...
!(function (e, t) {
  ...
  var S = (function (e) {
    ...
    try {
      O.apply((I = D.call(x.childNodes)), x.childNodes), I[x.childNodes.length].nodeType;
    } catch (t) {
      O = {
        apply: I.length
          ? function (e, t) {
            ...
            (M = t
              ...
              : function (e, t) {
                  ...
                  var n,
                    ...
                    o = [t];
                  if (!s || !a)
                    return e == f ? -1 : t == f ? 1 : s ? -1 : a ? 1 : d ? z(d, e) - z(d, t) : 0;
        ...
        ce(function (a, r, o, l) {
          ...
          if (a) {
            if (s || e) {
              ...
              for (d = v.length; d--; )
                (u = v[d]) && -1 < (c = s ? z(a, u) : p[d]) && (a[c] = !(r[c] = u));
            }
  ...
  x.ajaxSetup({
    ...
    x.each(["top", "left"], function (e, t) {
      x.cssHooks[t] = qe(f.pixelPosition, function (e, n) {
        if (n) return (n = Be(e, t)), ze.test(n) ? x(e).position()[t] + "px" : n;
      });
    }),
  ...
  (function (e, t) {
    ...
    var g = function (e, n, i) {
        ...
        return (
          h(i) &&
            ((s = "leading" in i ? !!i.leading : s), (a = "trailing" in i ? !!i.trailing : a)),
          (function (e, n, i) {
            var s,
              a,
              r,
    ...
    function I(e) {
      ...
      e = e.replace(v, "");
      var n = y.test(e);
      return n || w.test(e) ? x(e.slice(2), n ? 2 : 8) : b.test(e) ? NaN : +e;
    }
    var A = function (e, t, n) {
        ...
        return (
          ...
          P(n) &&
            ((d = !!n.leading),
            (a = (u = "maxWait" in n) ? $(I(n.maxWait) || 0, t) : a),
            (p = "trailing" in n ? !!n.trailing : p)),
          (v.cancel = function () {
            void 0 !== o && clearTimeout(o), (c = 0), (i = l = s = o = void 0);
          }),
          (v.flush = function () {
            return void 0 === o ? r : g(M());
          }),
          v
        );
      },
    ...
    var z = function () {
      ...
      N = function (e, t) {
        var n = window.document,
          i = new (D())(O);
        (L = t), i.observe(n.documentElement, { childList: !0, subtree: !0, removedNodes: !0 });
      },
      j = (function () {
        function e(e, t) {
    ...
    var W = new ((function () {
              ...
              a =
                ...
                function () {
                  e.animated &&
                    ...
                    _("aos:out", s),
                    e.options.id && _("aos:in:" + e.options.id, s),
                    (e.animated = !1));
                });
                ...
                out:
                  ...
                  (function (e, t) {
                    ...
                    var n = G(e, "anchor"),
                      ...
                      s = e;
                    return (
                      n && document.querySelectorAll(n) && (s = document.querySelectorAll(n)[0]),
                      V(s).top + s.offsetHeight - i
                    );
                  })(e.node, t.offset),
              }),
      ...
      ne = function () {
        if (((Z = K()), se(J.disable) || ee())) return ie();
        te();
      },
      ie = function () {
    ...
    return {
      init: function (e) {
        return (
          ...
          J.disableMutationObserver || N("[data-aos]", ne),
          se(J.disable) || ee()
            ? ie()
            : (document.querySelector("body").setAttribute("data-aos-easing", J.easing),
              ...
              "DOMContentLoaded" === J.startEvent &&
                ...
                te(!0),
              window.addEventListener("resize", A(te, J.debounceDelay, !0)),
              window.addEventListener("orientationchange", A(te, J.debounceDelay, !0)),
              Z)
        );
      },
      refresh: te,
    ...
    (d.prototype.destroy = function () {
      ...
      (d.prototype.limitPosition = function (e, t, n, i) {
        ...
        return (
          ...
          i > a ? (t = (t = t > 0 ? 0 : t) < a - i ? a - i : t) : (t = Math.max(0, a / 2 - i / 2)),
          { top: t, left: e }
        );
      }),
                    ...
                    if (!C.prop("readonly")) {
                      ...
                      if (!(t.ctrlKey || t.altKey || t.metaKey || 32 > r) && r && 13 !== r) {
                        if (
                          ...
                          (n = g(o.begin - 1)),
                          p > n && ((i = String.fromCharCode(r)), l[n].test(i)))
                        ) {
                          if (
                            ((function (e) {
                              var t, n, i, s;
                              for (t = e, n = m(e); p > t; t++)
                                if (l[t]) {
                                  if (
                                    ((i = g(t)), (s = S[t]), (S[t] = n), !(p > i && l[i].test(s)))
                                  )
                                    break;
                                  n = s;
                                }
  ...
  jQuery(function (e) {
    ...
    const i = new Swiper(".direct-slider .swiper-container", {
    ...
    i.on("click", function (t) {
      e(t.clickedSlide).next().hasClass("swiper-slide-prev") && i.slidePrev(),
        e(t.clickedSlide).prev().hasClass("swiper-slide-next") && i.slideNext();
    });
    ...
    if (screenWidth <= 520) {
      ...
      if ($("div").is(".cans-slider")) {
        $(".cans-slider .swiper-wrapper").append($(".can-item"));
        $(".cans-slider").addClass("swiper-container");
        $(".can-item").each(function (index, element) {
          if (!$(element).hasClass("card-three") && !$(element).hasClass("card-four")) {
    ...
    new Swiper(".stadi-slider .swiper-container", {
      ...
      var $progressBar = $(".raket-progress");

      $progressBar.removeClass("active stad2 stad3 stad4");
      const startWidth = document.querySelector(".stadi-footer .raket-progress .raket").offsetWidth;
      switch (activeIndex) {
        case 0:
          $progressBar.css("width", `${startWidth}`);
          break;
        case 1:
          $progressBar.css("width", "37%").addClass("active");
          break;
        case 2:
          $progressBar.css("width", "57%").addClass("active stad2");
          break;
        case 3:
          $progressBar.css("width", "75%").addClass("active stad3");
          break;
        case 4:
          $progressBar.css("width", "100%").addClass("active stad4");
          break;
      }
    });
    ...
    new Swiper(".cases-slider.swiper-container", {
      ...
      navigation: { prevEl: ".case-navigation .case-prev", nextEl: ".case-navigation .case-next" },
    });
            ...
            (n.find("input,textarea").each(function () {
              ...
              if (e(this).attr("required") && !n)
                ...
                let t = e(this).attr("minlength"),
                  a = n.length;
                if (t && a < t)
                  e("<div class='errorTextForm'>Заполните поле верно</div>").insertAfter(e(this)),
                    e(this).hasClass("errorInput") || e(this).addClass("errorInput"),
                    i || (i = !0);
                else {
        ...
        n == localStorage.getItem("rand") || n == localStorage.getItem("wr")
          ? ((n = Math.floor(Math.random() * t) + 1),
            ...
            n == localStorage.getItem("rand") || n == localStorage.getItem("wr")
              ...
              : ((i = n), localStorage.setItem("rand", n)))
          : ((i = n), localStorage.setItem("rand", n)),
          (e(".footer-next .next-title")[0].text = s["name" + i]),
          (e(".footer-next .next-title")[0].href = s["link" + i]),
          (e(".footer-next .work-wave")[0].href = s["link" + i]);
      }
    }
...
const showTab = (elTabBtn) => {
  ...
  const elTabPane = elTab.querySelector(`.works-items[data-id="${targetId}"]`);
  if (elTabPane) {
    const elTabBtnActive = elTab.querySelector(".tab-btn-active");
    elTabBtnActive.classList.remove("tab-btn-active");
    const elTabPaneShow = elTab.querySelector(".works-items-show");
    elTabPaneShow.classList.remove("works-items-show");
    elTabBtn.classList.add("tab-btn-active");
    elTabPane.classList.add("works-items-show");
  }
};
