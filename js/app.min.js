...
!(function (e, t) {
  ...
  jQuery(function (e) {
    ...
    let n = new Swiper(".cases-mob.swiper-container", {
      ...
      h = e(window).height();
      s >= 520
      ? (((s<=780 || s>=1280) && (h<=700 || h>=800)) && i > 150 && (e(".menu-top").addClass("scrolled-fix"), e(".top-header").css("z-index", 100)),
      ((s<=780 || s>=1280) && (h<=700 || h>=800)) && i < 150 && (e(".menu-top").removeClass("scrolled-fix"), e(".top-header").css("z-index", 2)))
      ...
      e(window).on("scroll", function () {
        ...
        if (
          ...
          s > 520
            ? (((s<=780 || s>=1280) && (h<=700 || h>=800)) && i > 150 &&
    ...
    const a = new Swiper(".direct-slider .swiper-container", {
      ...
      breakpoints: {
        0: { initialSlide: 2, slidesPerView: "1" },
        521: { initialSlide: 4, slidesPerView: "auto" },
      },
    });
      ...
      new Swiper(".stadi-slider .swiper-container", {
        ...
        switch (t) {
          case 0:
            ...
            break;
          case 1:
            w>=780 && w<=1280 && h>=700 && h<=800 ? n.css("width", "15%").addClass("active"):n.css("width", "37%").addClass("active");
            break;
          case 2:
            w>=780 && w<=1280 && h>=700 && h<=800 ? n.css("width", "30%").addClass("active stad2"):n.css("width", "57%").addClass("active stad2");
            break;
          case 3:
            w>=780 && w<=1280 && h>=700 && h<=800 ? n.css("width", "45%").addClass("active stad3"):n.css("width", "75%").addClass("active stad3");
            break;
          case 4:
            w>=780 && w<=1280 && h>=700 && h<=800 ? n.css("width", "60%").addClass("active stad4"):n.css("width", "100%").addClass("active stad4");
        }
      }),
