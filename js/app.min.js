...
!(function (e, t) {
  ...
  jQuery(function (e) {
    ...
    e(window).height();
    s > 520
      ? (i > 150 && (e(".menu-top").addClass("scrolled-fix"), e(".top-header").css("z-index", 100)),
        i < 150 && (e(".menu-top").removeClass("scrolled-fix"), e(".top-header").css("z-index", 2)))
    ...
    /* if (
      ((r = {
        ...
        name4: "Арт-ПринтАйдентика «Вечеров Дау»",
