...
!(function (e, t) {
  ...
  jQuery(function (e) {
      ...
      e(window).on("scroll", function () {
        ...
        if (
          ...
          s > 520
            ? (s >= 780 && s <= 1280 /* && h >= 700 && h <= 800 */
                ? (i > 150 &&
                    (e(".pink-screen").addClass("scrolled-min"),
                    e(".first-screen").addClass("scrolled-min"),
                    e(".main-menu-line")
                      .toggleClass("scrolled-main-menu-line")
                      .toggleClass("main-menu-line")),
                  i < 150 &&
                    (e(".pink-screen").removeClass("scrolled-min"),
                    e(".first-screen").removeClass("scrolled-min"),
                    e(".scrolled-main-menu-line")
                      .toggleClass("scrolled-main-menu-line")
                      .toggleClass("main-menu-line")))
                : i > 150 &&
                  (e(".menu-top").addClass("scrolled-fix"), e(".top-header").css("z-index", 100)),
    ...
    ($(window).width() <= 520 ||
      ($(window).width() >= 521 &&
        $(window).width() <= 800)) /* && $(window).height()>=780 && $(window).height()<=1280 */ &&
