      ...
      e("div").is(".first-main-container") &&
        ...
        setTimeout(function () {
          t({
            ...
            data: [{ text: "Космическое качество продуктов" }],
          });
        }, 1e3),
        setTimeout(function () {
          t({
            ...
            data: [{ text: "Вертикальный взлёт Вашего бизнеса" }],
          });
        }, 1100),
        setTimeout(function () {
          t({
            ...
            data: [{ text: "Поддержка на протяжении всего полета" }],
          });
        }, 1200),
        setTimeout(function () {
          t({
            ...
            data: [
              {
                text: "Sputnik Solutions — это качественные IT-решения для Вашего бизнеса. Делаем сайты, ботов, мобильные приложения, интегрируем технологии Data Science и Machine Learning. Sputnik Solutions — просто космос!",
              },
            ],
          });
        }, 1400)),
        ...
        setTimeout(function () {
          e("#wrt2").removeClass("wrt-non"),
            t({
              typingSpeed: 15,
              element: document.getElementById("wrt2"),
              data: [{ text: "История Sputnik Solutions и всё, что вы хотели знать о нас" }],
            });
        }, 300));
            ...
            setTimeout(function () {
              e("#wrt6").removeClass("wrt-non").addClass("wrt-yes"),
                t({
                  ...
                  data: [
                    {
                      text: "За каждой карточкой стоит команда заботливых, опытных специалистов. А ещё у нас индивидуальный подход и техническая поддержка",
                    },
                  ],
                });
            }, 100);
            ...
            setTimeout(function () {
              e(".wrt12").removeClass("wrt-non").addClass("wrt-yes"),
                ...
                t({
                  ...
                  data: [
                    {
                      text: "Решаем проблему слабой коммуникации граждан и местных властей с помощью технологий искусственного интеллекта. История о том, как мы в Sputnik Solutions делаем города России лучше — не «сделаем лучше», а именно «делаем лучше», прямо сейчас",
                    },
                  ],
                }),
                t({
                  ...
                  data: [
                    {
                      text: "“Shanti” с санскрита — «спокойствие», «гармония». Благодаря гармоничному сайту клиенты компании чувствуют себя спокойно и уверенно. Клиентов на сайте, кстати, теперь много благодаря презентации от Sputnik Solutions",
                    },
                  ],
                }),
                t({
                  ...
                  data: [
                    {
                      text: "Почему сайт — это критически важно для компании. Расписываем в красках то, как мы создали новый сайт типографии «Арт-Принт», совмещая лёгкий современный дизайн и классический стиль компании. Решение подняло продажи типографии на 80%",
                    },
                  ],
                }),
                t({
        ...
        if (e("div").is("#team")) {
          ...
          i > n &&
            ...
            t({
              typingSpeed: 20,
              element: document.getElementById("wrt4"),
              data: [{ text: "<h4>Андрей Перевозчиков</h4><p>co-founder</p>" }],
            }),
            ...
            t({
              ...
              data: [
                {
                  text: "<p>Сооснователь e-commerce стартапа в сфере международного B2B взаимодействия.</p><p>Опыт переговоров с крупными отечествеными и зарубежными компаниями.</p>",
                },
              ],
            }),
            e("#wrt6").removeClass("wrt-non").addClass("wrt-yes"),
            ...
            t({
              ...
              data: [
                {
                  text: "Стратегическое планирование развития компании, взаимодействие с клиентами, установление партнёрских отношений",
                },
              ],
            }),
            e("#wrt8").removeClass("wrt-non").addClass("wrt-yes"),
            t({
              typingSpeed: 20,
              element: document.getElementById("wrt8"),
              data: [{ text: "<h4>Дмитрий Дергунов</h4><p>co-founder</p>" }],
            }),
            e("#wrt9").removeClass("wrt-non").addClass("wrt-yes"),
            t({
              typingSpeed: 20,
              ...
              data: [
                {
                  text: "Продолжительный срок работал продакт-менеджером в перспективной IT-студии. Ушёл из неё, чтобы основать Sputnik Solutions.",
                },
              ],
            }),
            e("#wrt10").removeClass("wrt-non").addClass("wrt-yes"),
            ...
            t({
              ...
              data: [
                {
                  text: "Стратегическое планирование развития компании, разработка внутренних продуктов, привлечение инвестиций",
                },
              ],
            }),
            e("#wrt12").removeClass("wrt-non").addClass("wrt-yes"),
            t({
              ...
              data: [{ text: "<h4>Василий Писляков</h4><p>co-founder</p>" }],
            }),
            e("#wrt13").removeClass("wrt-non").addClass("wrt-yes"),
            t({
              typingSpeed: 20,
              ...
              data: [
                {
                  text: "Соавтор МЦД-4 и других транспортных проектов Московского региона. Физтех в третьем поколении. Написал текст, который Вы читаете сейчас.",
                },
              ],
            }),
            e("#wrt14").removeClass("wrt-non").addClass("wrt-yes"),
            ...
            t({
              ...
              data: [
                {
                  text: "Общее управление компанией, разработка маркетинговых стратегий, управление брендом и коммуникация с клиентами.",
                },
              ],
            }),
            ...
            t({
              ...
              data: [{ text: "<h4>Дмитрий Запорожченко</h4><p>CTO</p>" }],
            }),
            ...
            t({
              ...
              data: [
                {
                  text: "Более семи лет работы разработчиком, в том числе на позиции Senior-developer в крупнейшей IT-компании страны. Знает про программирование чуть больше, чем всё.",
                },
              ],
            }),
            ...
            t({
              ...
              data: [
                {
                  text: "Техническая стратегия компании, технологическая инфраструктура и инновации, повышение квалификации сотрудников.",
                },
              ],
            }),
            ...
            t({
              ...
              data: [{ text: "<h4>Александр Сопа</h4><p>CDO</p>" }],
            }),
            ...
            t({
              ...
              data: [
                {
                  text: "Создаёт красивое. Дизайнер с многолетним опытом работы в сфере создания айдентики и построения стиля. Разработал дизайн сайта, на котором Вы читаете этот текст.",
                },
              ],
            }),
            ...
            t({
              ...
              data: [
                {
                  text: "Создание дизайна продуктов, развитие брендов и построение их позиционирования",
                },
              ],
            }),
            ...
            t({
              ...
              data: [{ text: "более 20 сотрудников" }],
            }));
        }
        if (
          (setTimeout(function () {
        ...
        setTimeout(function () {
          e("#wrt1").removeClass("wrt-non"),
            t({
              ...
              data: [
                {
                  text: "Мы создаём сайты космического качества под ключ, отвечающие всем потребностям наших клиентов. Команда профессионалов Sputnik Solutions обеспечивает полный цикл разработки от анализа рынка и создания первоклассного дизайна до запуска продукта и дальнейшей техподдержки. Благодаря индивидуальному подходу к работе мы можем разработать веб-сайты любой сложности, будь то лёгкие лендинги или сложные корпоративные порталы.",
                },
              ],
            });
        }, 10),
        ...
        setTimeout(function () {
          e("#wrt1").removeClass("wrt-non"),
            t({
              ...
              data: [
                {
                  text: "Мы создаём мобильные приложения для операционных систем iOS и Android, применяя индивидуальный подход к каждому проекту. Команда Sputnik Solutions обладает большим опытом в создании интуитивно понятных, удобных приложений. В процессе разработки мы создаём MVP для оперативного вывода на рынок и тестирования гипотез, в рамках бета-тестирования оцениваем эффект от решения. Такой подход позволяет создавать мобильные приложения космического качества.",
                },
              ],
            });
        }, 10),
        ...
        setTimeout(function () {
          e("#wrt1").removeClass("wrt-non"),
            t({
              ...
              data: [
                {
                  text: "Создаём дизайн, выстраиваем бренд и айдентику для вашего бизнеса. Графические решения команды Sputnik Solutions сделают ваш визуал запоминающимся и вдохновляющим. Мы считаем, что именно на идее всегда строится интерес и узнаваемость продукта, поэтому в фундамент любого нашего решения мы вкладываем душу и заинтересованность, профессиональные навыки креатора. Душу — в первую очередь.",
                },
              ],
            });
        }, 10),
