...
!(function (e, t) {
  ...
  jQuery(function (e) {
    ...
    const a = new Swiper(".direct-slider .swiper-container", {
      ...
      breakpoints: {
        0: { initialSlide: 2, slidesPerView: "1",spaceBetween: 30 },
    ...
    ($(window).width() <= 520 || ($(window).width() >=521 && $(window).width()<=800 && $(window).height()>=780 && $(window).height()<=1280)) &&
    ...
    e(window).on("resize", function () {
      ...
      n <= 520 &&
        ...
        n > 520 && !(n>=521 && n<=800 && v>=780 && v<=1280) &&
          (e(".cans-slider").hasClass("swiper-container") &&
