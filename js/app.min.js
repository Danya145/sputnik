  ...
  jQuery(function (e) {
    ...
    const a = new Swiper(".direct-slider .swiper-container", {
      ...
      breakpoints: {
        ...
        701: { initialSlide: 4, slidesPerView: "auto", spaceBetween: 20 },
      },
    });
    ...
    ($(window).width() <= 520 || ($(window).width() >=521 && $(window).width()<=700 /* && $(window).height()>=780 && $(window).height()<=1280 */)) &&
    ...
    e(window).on("resize", function () {
      ...
      n <= 520 &&
        ...
        n > 520 && !(n>=521 && n<=700 /* && v>=780 && v<=1280 */) &&
          (e(".cans-slider").hasClass("swiper-container") &&
